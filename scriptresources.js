...
const notes = [
 { title: "Compounds of Life-that fat, protein, etc.", subject: "Biology", link: "https://docs.google.com/document/d/1rp3mzONRls5FifB_oemupViK7D6OJrLVnw4IivvN-dY/edit?usp=sharing" },
  ...
  { title:"Weather Fronts & Air Masses-properties and weather", subject:"Environmental Science", link:"https://docs.google.com/document/d/14yDCuKTEO8QID2kx_3-8KhTrUThGXJUK82nrZQXpTqE/edit?usp=sharing"},
  ...
  { title:"Degrees and Leading Coefficients-how to find the polynomial shape/end behavior", subject:"Algebra 2 (II)", link:"https://docs.google.com/presentation/d/1MEzP4yU0SnTtR5zSkNcgyQcTDoKlFR7a2VjaAUTmAVI/edit?usp=sharing"},
  ...
  { title:"Battle of Lexington & Concord: The Shot Heard 'Round the World (a choose-your-adventure mini-game slidesshow)", subject:"US History", link:"https://docs.google.com/presentation/d/168Aop1rB3NBQNOo8Mr5DkIh55VHAQFvr-cilMqG1lDk/edit?usp=sharing"},

];

 linkContainer.innerHTML = "Results will pop up here!"
...
function displayResults(results) {
    ...
    if (results.length == 0) {
        ...
        results.forEach(note => {
            let noteElement = document.createElement("a");
